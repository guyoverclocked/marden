...
export function EditorScreen({
  ...
  const [title, setTitle] = useState(document?.title || initialDraft?.title || '');
  const [content, setContent] = useState(document?.content || initialDraft?.content || '');
  const [projectId, setProjectId] = useState<string | null>(document?.projectId || initialDraft?.projectId || null);
      ...
      >
        <View style={[styles.header, darkMode && styles.headerDark]}>
          ...
          <View style={styles.headerCenter}>
            <Text style={[styles.headerEyebrow, darkMode && styles.headerEyebrowDark]}>
              {document ? 'EDIT MARKDOWN' : initialDraft ? 'CLIPBOARD CAPTURE' : 'NEW MARKDOWN'}
            </Text>
            <Text style={[styles.headerTitle, darkMode && styles.headerTitleDark]}>
              {document ? 'Edit in Marden' : initialDraft ? 'Review your capture' : 'Write in Marden'}
            </Text>
          </View>
          <Pressable
            accessibilityRole="button"
          ...
          <View style={[styles.editorLayout, desktop && styles.editorLayoutDesktop]}>
            <View style={[styles.aiHint, darkMode && styles.aiHintDark]}>
              ...
              <Text style={[styles.aiHintText, darkMode && styles.aiHintTextDark]}>
                Paste from any AI app: long-press in the editor, then choose <Text style={[styles.aiHintStrong, darkMode && styles.aiHintStrongDark]}>Paste</Text>. Or use one-tap capture from your library.
              </Text>
            </View>
